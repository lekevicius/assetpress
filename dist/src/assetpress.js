...
var android_1 = require("./modules/android");
var ios_1 = require("./modules/ios");
var splitter_1 = require("./modules/splitter");
...
function default_1(passedOptions, callback) {
...
performWorkflow = function (workflowObject, callback) {
    ...
    if (workflowObject.screens) {
        ...
        splitter_1.default(screensObject.source, screensObject.resourcesDestination, screensObject.screensDestination, screensObject.options);
    ...
    if (workflowObject.assetpress && _.isObject(workflowObject.assetpress)) {
        ...
        switch (workflowObject.assetpress.os) {
            case 'android':
                ...
                return android_1.default(temporarySourceDirectory, workflowObject.output.destination, androidOptions, completeFunction);
            case 'ios':
                iosOptions = {
                    verbose: workflowObject.verbose,
                    clean: workflowObject.output.clean,
                ...
                return ios_1.default(temporarySourceDirectory, workflowObject.output.destination, iosOptions, completeFunction);
        }
    }
    else {
...
//# sourceMappingURL=assetpress.js.map